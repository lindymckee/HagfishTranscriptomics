##Written by David Plachetzki and the Plachetzki lab. Edited by Lindy McKee and Stephen Mrenna
#! /usr/bin/env python3
...
#For the actinula transcriptome it will look like Ec_actinula_t.1 : ./3.A_rename_fa_headers.py -a Trinity.fasta -b MG_
